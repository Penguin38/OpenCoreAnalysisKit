...
#ifndef PARSER_COMMAND_FAKE_CORE_ARM_FAKECORE_IMPL_H_
#define PARSER_COMMAND_FAKE_CORE_ARM_FAKECORE_IMPL_H_
...
#endif // PARSER_COMMAND_FAKE_CORE_ARM_FAKECORE_IMPL_H_
