...
#ifndef PARSER_COMMAND_REMOTE_FAKE_CORE_ARM_PROCESS_PARSER_H_
#define PARSER_COMMAND_REMOTE_FAKE_CORE_ARM_PROCESS_PARSER_H_
...
#endif  // PARSER_COMMAND_REMOTE_FAKE_CORE_ARM_PROCESS_PARSER_H_
