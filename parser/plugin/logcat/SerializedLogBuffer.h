...
#ifndef PARSER_PLUGIN_LOGCAT_SERIALIZED_LOGBUFFER_H_
#define PARSER_PLUGIN_LOGCAT_SERIALIZED_LOGBUFFER_H_
...
#endif // PARSER_PLUGIN_LOGCAT_SERIALIZED_LOGBUFFER_H_
