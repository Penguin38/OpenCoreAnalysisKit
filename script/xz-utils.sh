...
cmake -DCMAKE_C_COMPILER=$BUILD_HOST_C_COMPILER \
      ...
      xz-utils/CMakeLists.txt \
      -B $INSTALL_OUTPUT/linux/xz-utils

make -C $INSTALL_OUTPUT/linux/xz-utils -j8
...
cmake -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK_HOME/build/cmake/android.toolchain.cmake \
      ...
      -DCMAKE_POSITION_INDEPENDENT_CODE=ON \
      xz-utils/CMakeLists.txt \
      -B $INSTALL_OUTPUT/android/$CURRENT_ANDROID_ABI/xz-utils

make -C $INSTALL_OUTPUT/android/$CURRENT_ANDROID_ABI/xz-utils -j8
done
fi
