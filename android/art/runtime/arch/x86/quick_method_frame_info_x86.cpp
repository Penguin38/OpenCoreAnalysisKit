...
std::string X86QuickMethodFrameInfo::PrettySpillMask(uint32_t mask) {
    std::string sb;
    uint32_t bits = mask;
...
void X86QuickMethodFrameInfo::DumpCoreSpill(const char* prefix, uint64_t sp, uint32_t core_mask, uint32_t frame_size) {
