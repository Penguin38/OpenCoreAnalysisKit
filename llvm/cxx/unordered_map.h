...
#ifndef LLVM_CXX_UNORDERED_MAP_H_
#define LLVM_CXX_UNORDERED_MAP_H_

#include "api/memory_ref.h"

struct cxx_unordered_map_OffsetTable {
...
struct cxx_unordered_map_SizeTable {
    uint32_t THIS;
    uint32_t bucket_list_size;
    uint32_t pair_size;
};

extern struct cxx_unordered_map_OffsetTable __cxx_unordered_map_offset__;
extern struct cxx_unordered_map_SizeTable __cxx_unordered_map_size__;
...
public:
    ...
    static void Init();
    inline uint64_t __bucket_list() { return Ptr() + OFFSET(cxx_unordered_map, __bucket_list_); }
    inline uint64_t __p1() { return VALUEOF(cxx_unordered_map, __p1_); }
    inline uint64_t __p2() { return VALUEOF(cxx_unordered_map, __p2_); }
    inline uint64_t __p3() { return VALUEOF(cxx_unordered_map, __p3_); }
    ...
    public:
        ...
        inline uint64_t __next() { return VALUEOF(cxx_unordered_map, __pair__next_); }
        inline uint64_t __hash() { return VALUEOF(cxx_unordered_map, __pair__hash_); }
        inline uint64_t __data() { return Ptr() + OFFSET(cxx_unordered_map, __pair__data_); }
    };
    ...
    public:
        ...
        uint64_t operator*();
    private:
        unordered_map::pair pair_cache = 0x0;
    };
...
#endif  // LLVM_CXX_UNORDERED_MAP_H_
